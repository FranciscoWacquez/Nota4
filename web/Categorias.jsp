    ...
    <div class="nav-wrapper brown">
      <a href="bienvenido.jsp" class="brand-logo">
          <c:if test="${not empty sessionScope.admin}">
              Bievenido ${sessionScope.admin.nombreUser}
      ...
      <div class="row">
        ...
        <div class="col s12">
            ...
            <form action="controcatl.do" method="POST">
                ...
                <button class="btn right brown" name="bt" value="nuevacategoria" type="submit">Guardar</button>
                <button class="btn left red" name="bt" value="" type="submit">Borrar</button>
            </form>
            ${requestScope.msg}
            <br><br>
...
<footer class="page-footer black darken-4">
          ...
          <div class="footer-copyright">
            <div class="container">
            © 2014 Copyright Text - Creado por Francisco Wacquez
