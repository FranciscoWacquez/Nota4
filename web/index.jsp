...
<div class="col s12"><span class="brown text-darken-2"><div class="card brown darken-1">
        <div class="card-content white-text">
            <center><span class="card-title">Restauran Té</span></center></h4></div></span></div>
<div class="container">
...
<br><br><br><br><br><br><br>
 <div class="col s12"><span class="white-text text-darken-2"><div class="card-panel hoverable black darken-2"><center>Copyright (c) 2018 Restauran Té
